...
// Assuming this is your answer submission function
function checkAnswer(answer) {
    // Check if the answer is correct
    if (answer == questions[que_count].answer) {
        // If correct, add the 'correct-answer' class to the body or a specific element
        ...
        // If incorrect, add the 'incorrect-answer' class to the body or a specific element
    ...
    // Continue with the rest of your answer submission logic...
}
...
function startTimerLine(time) {
    ...
    function timer() {
        ...
        if (time > 500) { //if time value is greater than 549
            clearInterval(counterLine); //clear counterLine
        }
    }
}
